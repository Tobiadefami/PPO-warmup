...
from ppo_warmup.buffer import RolloutBuffer
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                # Normalize advantage
                advantages = self.normalize_advantages(rollout_data.advantages)

                # ratio between old and new policy, should be one at the first iteration
                ratio = self.compute_ratio(log_prob, rollout_data.old_log_prob)

                # clipped surrogate loss
                policy_loss = self.compute_policy_loss(advantages, ratio, clip_range)
                ...
                value_loss = self.compute_value_loss(rollout_data.returns, values_pred)
